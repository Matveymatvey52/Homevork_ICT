...
- [`05_statistics/`](05_statistics) — задание папки 09 «Полиморфизм и все-все-все»:
  расчёт статистики последовательности (min, max, mean, std, pct90, pct95).
  Каждая статистика — отдельный класс-наследник интерфейса `IStatistics`.
